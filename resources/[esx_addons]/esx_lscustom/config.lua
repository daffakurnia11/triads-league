...
Config.RepairPrice       = 20000

Config.Zones = {
	-- Bennys
	ls1 = {
		Pos      = vector3(-211.55, -1324.55, 30.89),
	...
	-- Kota
	ls2 = {
		Pos      = vector3(-336.59, -137.24, 39.00),
		Name     = TranslateCap('blip_name'),
		Hint     = TranslateCap('press_repair'),
		Action   = 'repair',
		Distance = 5
	},
	...
	-- Bandara
	ls3 = {
		Pos      = vector3(-1156.12, -2008.40, 13.17),
		Name     = TranslateCap('blip_name'),
		Hint     = TranslateCap('press_repair'),
		Action   = 'repair',
		Distance = 5
	...
	-- Sandy Shores
	ls4 = {
		Pos      = vector3(1176.22, 2641.92, 37.73),
		Name     = TranslateCap('blip_name'),
		Hint     = TranslateCap('press_repair'),
		Action   = 'repair',
		Distance = 3
	...
	-- Paleto
	ls5 = {
		Pos      = vector3(111.70, 6625.23, 31.77),
		Name     = TranslateCap('blip_name'),
		Hint     = TranslateCap('press_repair'),
		Action   = 'repair',
		Distance = 3
